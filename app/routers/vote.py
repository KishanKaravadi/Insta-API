...
def vote(vote: schemas.Vote, db: Session = Depends(database.get_db), curr_user: models.User = Depends(oauth2.get_current_user)):
    ...
    vote_query = db.query(models.Vote).where(models.Vote.post_id ==
